  ...
  <tr>
    ...
    <td bgcolor="#e5e5e5" align="center">
        ...
        <tr>
   	      ...
   	      <td width="720" align="center" bgcolor="#ffffff"><img src="http://karmaresorts.com/wecreate/edm/Karma_Spa/KSpa_EDM_Yoga_facial/images/main_header.png" width="720" height="490" class="responsive_small" /></td>
       ...
       <tr>
		 ...
		 <tr>
   	      <td align="center" bgcolor="#ffffff" class="row_content fallback-text smltext" style="font-family: 'Open Sans', Arial, sans-serif;padding:15px 40px 15px 40px;">
						<p class="fallback-text" style="font-family: 'Open Sans', Arial, sans-serif;font-weight: 400; font-size: 14px; color: #1d1d1d; mso-line-height-rule: exactly;line-height:180%; Margin-top: 0; Margin-bottom: 0; text-align: center; letter-spacing: 0.1px;">
							<span style="font-size:16px;"><strong>GET YOUR GLOW</strong></span>
							<br />
		...
		<tr>
   	    <td align="center" bgcolor="#ffffff" class="row_content fallback-text smltext" style="font-family: 'Open Sans', Arial, sans-serif;padding: 0px 40px 15px 40px;">
						<p class="fallback-text" style="font-family: 'Open Sans', Arial, sans-serif;font-weight: 400; font-size: 22px; color: #434343; mso-line-height-rule: exactly;line-height:180%; Margin-top: 0; Margin-bottom: 0; text-align: center; letter-spacing: 0.1px;">
							<strong>IDR 750 +</strong>
						</p>
					</td>
        </tr>
         ...
         <tr>
   	      <td align="center" bgcolor="#ffffff">
				 <a href="mailto:spaasstmgr@karmakandara.com?subject=Inquiry The Yoga Facial" target="_blank">
						<img src="http://karmaresorts.com/wecreate/edm/Karma_Spa/KSpa_EDM_Yoga_facial/images/cta.png" width="174" height="46" />
					</a>
				</td>
        </tr>
